...
import thumbsUpIcon from "../../../public/assets/icons/thumbup.svg";
import thumbsDownIcon from "../../../public/assets/icons/thumbdown.svg";
import phoneIcon from "../../../public/assets/icons/mobile.svg";
import messageIcon from "../../../public/assets/icons/msg.svg";
...
const ContactUs = () => {
  return (
    <div className='flex flex-col items-center'>
        ...
        <div className="flex px-4 py-3 rounded-md md:w-[458px] w-[60%] border-2 border-text-secondary-gray mt-4 justify-between">
            <input className="focus-visible:outline-none w-[100%]" type="text" placeholder="What can we help you with?" name="" id="" />
            <Heart />
        </div>
        <div className="grid grid-cols-12 px-8 md:px-16 py-8 bg-white text-gray-800">
            ...
            <div className='col-span-12 md:col-span-3 mt-8'>
                <h2 className='uppercase font-bold text-xl text-center mb-5'>Contact Us</h2>
                {/* Phone Section */}
                ...
                {/* Chat Section */}
                <div className="flex flex-col items-center space-y-2 text-center">
                    <Image src={messageIcon} alt='Phone' width={40}/>
                    <p>24 hours a day</p>
                    <p>7 days a week</p>
                </div>
                ...
                {/* Email Section */}
                <div className="flex flex-col items-center space-y-2 text-center">
                    <Image src={emailIcon} alt='Phone' width={40}/>
                ...
                <div className="flex flex-col items-center space-y-2 text-center">
                    <Image src={locationIcon} alt='Phone' width={40}/>
