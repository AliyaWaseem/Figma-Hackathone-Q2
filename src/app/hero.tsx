...
export default function Hero() {
  return (
    <div className="w-full overflow-x-hidden">
      {/* head */}
      <div className="flex justify-center items-center w-full mx-auto h-[58px] bg-[#F5F5F5] text-black">
      ...
      <div className="flex justify-center items-center flex-col p-10">
                ...
                <div className="flex justify-center items-center gap-3 text-white"><Button>Notify Me</Button>
