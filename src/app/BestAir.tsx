...
import { products, ProductDetail } from "../components/data/detail2"; // Import the product data

const BestAir = () => {
  // Filter the best products (best1, best2, best3)
  const bestProducts = products.filter(product => ["P001", "P002", "P003"].includes(product.id)); // Cast to number
